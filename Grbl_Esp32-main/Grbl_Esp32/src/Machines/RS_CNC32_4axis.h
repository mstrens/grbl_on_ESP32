...
#define SPINDLE_OUTPUT_PIN      GPIO_NUM_2 // it was 25 on first version
#define SPINDLE_ENABLE_PIN      GPIO_NUM_17
...
#define CONTROL_FEED_HOLD_PIN   GPIO_NUM_21// it was 02 on first version  // labeled Hold
